  ...
  return (
    <div className="max-w-screen-xl mx-auto flex ">
      <section className="flex flex-col justify-center flex-1 space-y-4 py-12 md:py-16 lg:py-20 ml-24">
        <h2 className="text-4xl font-medium text-white leading-tight">Elevate C-Form Processing<br className="md:hidden" /> with qid State-of-the-Art Chrome Extension</h2>
