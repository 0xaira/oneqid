export default function Section2() {
    return (
      <div className="max-w-screen-xl mx-auto px-6 md:px-0 py-12 md:py-24 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-r from-black to-zinc-900 rounded-3xl p-6 flex border border-gray-700">
            <h2 className="text-3xl md:text-4xl lg:text-3xl font-bold text-white">Go to the C-Form website
              Open the qid C-Form Pro Chrome plugin.
              Select the guest. Done!</h2>
          </div>
        </div>
      </div>
    )
